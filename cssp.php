		...
		<ul class="list-unstyled">
			...
			<li>
				<a href="phone:<?php echo esc_attr(get_option('Pannenhilfe-Number')); ?>">
					<img src="http://www.onlinemarketingborken.de/bleker/assets/img/service-1.png" class="service-icon">
			...
			<li>
				<a href="<?php echo esc_attr(get_option('Werkstatt-Link')); ?>">
					<img src="http://www.onlinemarketingborken.de/bleker/assets/img/service-2.png" class="service-icon">
			...
			<li>
				<a href="<?php echo esc_attr(get_option('Probefahrt-Number')); ?>">
					<img src="http://www.onlinemarketingborken.de/bleker/assets/img/service-3.png" class="service-icon">
			...
			<li>
				<a href="<?php echo esc_attr(get_option('Broschueren-Number')); ?>">
					<img src="http://www.onlinemarketingborken.de/bleker/assets/img/service-4.png" class="service-icon">
